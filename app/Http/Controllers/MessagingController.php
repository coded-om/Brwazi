...
class MessagingController extends Controller
{
    ...
    public function startConversation(Request $request)
    {
        ...
        return redirect()->route('user.conversation', $conversation->id);
    }
    ...
    public function searchUsers(Request $request)
    {
        ...
        $users = User::where('id', '!=', $user->id)
            ...
            ->select('id', 'fname', 'lname', 'email', 'ProfileImage', 'tagline')
            ->limit(10)
            ->get();
    ...
    public function sendMessage(Request $request, Conversation $conversation)
    {
        ...
        $messageType = Message::determineType($content, $imagePath);
    ...
    public function sendArtworkRequest(Request $request, Conversation $conversation)
    {
        ...
        $request->validate([
            ...
            // الميزانية وتاريخ التسليم اختياريان، لكن إن وُجدا يجب أن يكونا صالحين
            'budget' => 'nullable|numeric|min:1',
            'deadline' => 'nullable|date|after:today',
            // حد أقصى 5 صور مرجعية، كل صورة 2MB
        ...
        try {
            ...
            $artworkRequest = ArtworkRequest::create([
                ...
                // الحقل مُعرّف كـ cast array، لذلك نخزن كمصفوفة وسيتم تحويله إلى JSON تلقائياً
